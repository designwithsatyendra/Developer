        ...
        <Container>
          ...
          <Box style={{ textAlign: 'justify' }}>
            <Typography variant="body2" sx={{ mb: 2 }}>
              ...
              money for my sister's marriage. I need money for my sister's marriage.So I decided to share my knowledge
              on YouTube. For 2 Month's I have been sharing knowledge on coding and uploading many videos on YouTube. So
              I believed in "Just keep doing the good things in life by helping others and don't expect anything in
              return because God is watching and Karma will give us everything for sure”.
            </Typography>
            <Typography variant="body2" sx={{ mb: 2 }}>
            ...
            <Typography variant="body2" sx={{ mb: 2 }}>
              Here is my PAYTM, GOOGLE PAY, PHONE PAY Number 7869351845. You have to pay {sourcecodeprice.price}Rs on
              this Number. Thanks in advance.
            </Typography>
            <Typography variant="body2" sx={{ mb: 2 }}>
              Uper diya gaya number 7869351845 me PAYTM, GOOGLE PAY, PHONE PAY tino me koi ek online payment aap kar
              sakte ho. Only {sourcecodeprice.price}RS pay krna hai. Ek bar hone ke baad screenshot muje
              <span style={{ color: 'purple' }}>WhatsApp me HERE</span> same number par kr dijiyega. Me apko source code
              share kr doonga. Dhanyawad.
            </Typography>
            <Typography variant="body2" sx={{ mb: 2 }}>
              **Those who Pay <span style={{ color: 'purple' }}>WhatsApp me HERE</span> with a screenshot of payment.
              And, only those will get the source code**
            </Typography>
